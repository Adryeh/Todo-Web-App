...
class BaseResponse(object):
    ...
    subclasses of response objects and you want to posts process them with a
    known interface.
    ...
    def force_type(cls, response, environ=None):
        ...
        This is especially useful if you want to posts-process responses in
    ...
    def is_streamed(self):
        ...
        This is useful for checking before applying some sort of posts
