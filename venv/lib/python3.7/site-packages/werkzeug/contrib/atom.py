...
"""
    ...
    Example::
        ...
        def atom_feed(request):
            ...
            for posts in Post.query.limit(10).all():
                feed.add(posts.title, posts.body, content_type='html',
                         author=posts.author, url=posts.url, id=posts.uid,
                         updated=posts.last_update, published=posts.pub_date)
